...
export const FACTORY_TEMPLATES: ProjectTemplate[] = [
  {
    ...
    genre: 'pop',
    tracks: [
      { name: 'DKT-SEQ-01 Piano', type: 'midi', volume: -3, pan: 0 },
      { name: 'DKT-AUD-01 Vocal', type: 'audio', volume: 0, pan: 0 },
      { name: 'DKT-SEQ-02 Drums', type: 'midi', volume: -2, pan: 0 },
      { name: 'DKT-SEQ-03 Bass', type: 'midi', volume: -4, pan: 0 },
    ],
    routingDefaults: [
  ...
  },
  {
    ...
    genre: 'edm',
    tracks: [
      { name: 'DKT-SEQ-01 Lead', type: 'midi', volume: -4, pan: 0 },
      { name: 'DKT-SEQ-02 Pad', type: 'midi', volume: -6, pan: -0.2 },
      { name: 'DKT-SEQ-03 Bass', type: 'midi', volume: -3, pan: 0 },
      { name: 'DKT-SEQ-04 Drums', type: 'midi', volume: -2, pan: 0 },
      { name: 'DKT-AUD-01 FX', type: 'audio', volume: -8, pan: 0.3 },
    ],
    routingDefaults: [
      { type: 'return', name: 'Reverb' },
      { type: 'return', name: 'Delay' },
  ...
  },
  {
    ...
    genre: 'hip-hop',
    tracks: [
      { name: 'DKT-SEQ-01 Drums', type: 'midi', volume: -2, pan: 0 },
      { name: 'DKT-SEQ-02 808 Bass', type: 'midi', volume: -3, pan: 0 },
      { name: 'DKT-AUD-01 Sample', type: 'audio', volume: -4, pan: 0 },
      { name: 'DKT-SEQ-03 Melody', type: 'midi', volume: -5, pan: 0.1 },
    ],
    routingDefaults: [
      { type: 'return', name: 'Reverb' },
  ...
  },
  {
    ...
    genre: 'general',
    tracks: [
      { name: 'DKT-AUD-01 Kick', type: 'audio', volume: 0, pan: 0 },
      { name: 'DKT-AUD-02 Snare', type: 'audio', volume: 0, pan: 0 },
      { name: 'DKT-AUD-03 Hats', type: 'audio', volume: -3, pan: 0.3 },
      { name: 'DKT-AUD-04 Bass', type: 'audio', volume: 0, pan: 0 },
      { name: 'DKT-AUD-05 Keys', type: 'audio', volume: -2, pan: -0.2 },
      { name: 'DKT-AUD-06 Guitar', type: 'audio', volume: -2, pan: 0.2 },
      { name: 'DKT-AUD-07 Vocal', type: 'audio', volume: 0, pan: 0 },
      { name: 'DKT-AUD-08 FX', type: 'audio', volume: -6, pan: 0 },
    ],
    routingDefaults: [
      { type: 'group', name: 'Drums' },
  ...
  },
  {
    ...
    genre: 'classical',
    tracks: [
      { name: 'DKT-SEQ-01 Strings', type: 'midi', volume: -3, pan: -0.3 },
      { name: 'DKT-SEQ-02 Pad', type: 'midi', volume: -6, pan: 0.2 },
      { name: 'DKT-SEQ-03 Perc', type: 'midi', volume: -4, pan: 0 },
      { name: 'DKT-AUD-01 Ambient', type: 'audio', volume: -10, pan: 0 },
    ],
    routingDefaults: [
